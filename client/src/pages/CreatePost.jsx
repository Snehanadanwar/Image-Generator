        ...
        <form className="mt-5 mw-100  col-lg-8" onSubmit={handleSubmit}>
          ...
          <div className="mt-5 d-flex gap-5">
            <button
              ...
              className="text-white bg-green-700 font-medium rrounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
            >
          ...
          <div className="mt-4">
            ...
            <button type="submit" className="mt-3 text-white bg-[#6469ff] font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-centre">
